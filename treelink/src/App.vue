  ...
  data() {
    return {
      links: [
        ...
        { id: 4, name: '🔥 Discover the Hottest Real Estate Hacks of 2025! 🔥', url: 'https://mathesongrouprealty.dubb.com/v/JGA3Nd?from_email=1&_pxl=djoxLGM6MDNmODFhMzMzOTY1MzksYTox' },
      ],
...
.social-icons {
    ...
    align-items: center; /* Centers the icons vertically within the container */
    background-color: transparent; /* Set to desired background or keep transparent */
